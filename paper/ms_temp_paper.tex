...
We develop a new method for the calculation of dopplergrams using the MCMC fitting method to adapt to the problems of multiple forms of emmision absorption lines at the limb.
