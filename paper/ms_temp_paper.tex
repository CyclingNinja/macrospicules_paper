...
However, this drives the tip of the jet even higher than the initial.
...
Lastly we find that the jet has a rotational component to its motion.
We find that the jet has rotational velocities that maximise at the tip of the jet as the rotation initialises during the second acceleration of plasma.
After this onset 'untwisting' at the tip of the macrospicule, the unwinding spreads down the feature until we observe a division 50/50 red/blue, with the RHS initially moving away from us.
